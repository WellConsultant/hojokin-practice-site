...
export default function Home() {
  return (
    <main className="home-page">
      ...
      <section id="difference" className="home-difference section-pad">
        <div className="home-section-title">
          <h2>補助金実務サポートの流れ</h2>
          <p>資格名や「フルサポート」という言葉だけでは、何をしてもらえるか分かりません。申請、採択後、実績報告の各工程を確認してください。</p>
        </div>
        <div className="comparison-wrap">
          <table>
            <caption>依頼先へ確認する項目</caption>
            <thead><tr><th>確認すること</th><th>契約前に聞く質問</th><th>阿久津和宏の支援</th></tr></thead>
            <tbody>
              <tr><th>採択審査</th><td>制度選び、会社情報の聞き取り、対象経費、添付資料まで含むか</td><td>申請前の対象確認から事業計画、添付資料まで対応</td></tr>
              <tr><th>交付申請</th><td>見積、相見積、発注条件、差し戻しへの対応を行うか</td><td>交付決定を受けるための書類と回答を支援</td></tr>
              <tr><th>実績報告</th><td>支払証拠、写真、成果物、変更手続きを確認するか</td><td>実施前から必要な証拠を確認し、報告書作成を支援</td></tr>
              <tr><th>提出</th><td>誰が電子申請を操作し、誰が事務局へ回答するか</td><td>本人が行う操作と、行政書士が行う書類作成を分けて説明</td></tr>
              <tr><th>料金</th><td>着手金、成功報酬、追加対応、完了時点はいくらか</td><td>支援する作業と料金を見積書で提示</td></tr>
            </tbody>
          </table>
        </div>
      </section>
